...
import dev.ssjvirtually.util.XmlUtil;
...
public class XmlBeautifierView extends VBox {
    ...
    public XmlBeautifierView() {
        ...
        inputArea = createEditor("Enter XML...");
    ...
    private void beautify() {
        try {
            String result = XmlUtil.beautify(inputArea.getText());
    ...
    private void minify() {
        try {
            String result = XmlUtil.minify(inputArea.getText());
            outputArea.replaceText(result);
            clearError();
        } catch (Exception ex) {

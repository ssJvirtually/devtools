...
import dev.ssjvirtually.util.CssBeautifierUtil;
...
public class CssBeautifierView extends VBox {
    ...
    public CssBeautifierView() {
        ...
        inputArea = createEditor("Enter CSS...");
    ...
    private void beautify() {
        try {
            String result = CssBeautifierUtil.beautify(inputArea.getText());
    ...
    private void minify() {
        try {
            String result = CssBeautifierUtil.minify(inputArea.getText());
            outputArea.replaceText(result);
            clearError();
        } catch (Exception ex) {
